...
const DonaswapStableSwapFactory = artifacts.require("stable-swap/contracts/DonaswapStableSwapFactory.sol");
const DonaswapStableSwapLPFactory = artifacts.require("stable-swap/contracts/DonaswapStableSwapLPFactory.sol");
const DonaswapStableSwapTwoPoolDeployer = artifacts.require("stable-swap/contracts/DonaswapStableSwapTwoPoolDeployer.sol");
const DonaswapStableSwapThreePoolDeployer = artifacts.require("stable-swap/contracts/DonaswapStableSwapThreePoolDeployer.sol");
const DonaswapStableSwapTwoPool = artifacts.require("stable-swap/contracts/DonaswapStableSwapTwoPool.sol");
const DonaswapStableSwapThreePool = artifacts.require("stable-swap/contracts/DonaswapStableSwapThreePool.sol");
const DonaswapStableSwapTwoPoolInfo = artifacts.require("stable-swap/contracts/utils/DonaswapStableSwapTwoPoolInfo.sol");
const DonaswapStableSwapThreePoolInfo = artifacts.require("stable-swap/contracts/utils/DonaswapStableSwapThreePoolInfo.sol");
const DonaswapStableSwapInfo = artifacts.require("stable-swap/contracts/utils/DonaswapStableSwapInfo.sol");
const LPToken = artifacts.require("stable-swap/contracts/DonaswapStableSwapLP.sol");
...
const DonaswapFactory = artifacts.require("exchange-protocol/contracts/DonaswapFactory.sol");
const DonaswapPair = artifacts.require("exchange-protocol/contracts/DonaswapPair.sol");
const DonaswapRouter = artifacts.require("exchange-protocol/contracts/DonaswapRouter.sol");
...
contract("SmartRouter", ([admin, bob, carol]) => {
    ...
    before(async () => {
        ...
        /** Create Stable Swap */
        stableSwapLPFactory = await DonaswapStableSwapLPFactory.new({ from: admin });
        stableSwap2PoolDeployer = await DonaswapStableSwapTwoPoolDeployer.new({ from: admin });
        stableSwap3PoolDeployer = await DonaswapStableSwapThreePoolDeployer.new({ from: admin });
        stableSwapFactory = await DonaswapStableSwapFactory.new(stableSwapLPFactory.address, stableSwap2PoolDeployer.address, stableSwap3PoolDeployer.address, {
            from: admin,
        });
        stableSwap2PoolInfo = await DonaswapStableSwapTwoPoolInfo.new({ from: admin });
        stableSwap3PoolInfo = await DonaswapStableSwapThreePoolInfo.new({ from: admin });
        stableSwapPoolInfo = await DonaswapStableSwapInfo.new(stableSwap2PoolInfo.address, stableSwap3PoolInfo.address, { from: admin });
        ...
        stable2Pool_BUSD_USDC = await DonaswapStableSwapTwoPool.at(stable2PoolInfo.swapContract);
        ...
        stable2Pool_WBNB_BUSD = await DonaswapStableSwapTwoPool.at(stable2PoolInfo_WBNB_BUSD.swapContract);
        ...
        stable3Pool_BUSD_USDC_USDT = await DonaswapStableSwapThreePool.at(stable3PoolInfo.swapContract);
