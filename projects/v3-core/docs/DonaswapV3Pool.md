...
```solidity
struct DonaswapV3Pool.Slot0 slot0
```
...
```solidity
struct DonaswapV3Pool.ProtocolFees protocolFees
```
...
```solidity
contract IDonaswapV3LmPool lmPool
```
...
_Prevents calling a function from anyone except the address returned by IDonaswapV3Factory#owner()_
...
_The caller of this method receives a callback in the form of IDonaswapV3SwapCallback#donaswapV3SwapCallback_
...
_The caller of this method receives a callback in the form of IDonaswapV3FlashCallback#donaswapV3FlashCallback
...
```solidity
function setLmPool(contract IDonaswapV3LmPool _lmPool) external
```
