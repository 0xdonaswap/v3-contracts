...
import { DonaswapV3PoolSwapTest } from '../typechain-types/contracts/test/DonaswapV3PoolSwapTest'
...
describe('DonaswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('DonaswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as DonaswapV3PoolSwapTest
          ...
          let tester: DonaswapV3PoolSwapTest
