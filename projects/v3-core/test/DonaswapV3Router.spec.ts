...
describe('DonaswapV3Pool', () => {
  ...
  let pool0: MockTimeDonaswapV3Pool
  let pool1: MockTimeDonaswapV3Pool
  ...
  let swapTargetCallee: TestDonaswapV3Callee
  let swapTargetRouter: TestDonaswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeDonaswapV3Pool, any]> => {
