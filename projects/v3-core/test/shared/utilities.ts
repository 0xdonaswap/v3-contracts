...
export function createPoolFunctions({
  ...
  swapTarget: TestDonaswapV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeDonaswapV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestDonaswapV3Router
  poolInput: MockTimeDonaswapV3Pool
  poolOutput: MockTimeDonaswapV3Pool
}): MultiPoolFunctions {
