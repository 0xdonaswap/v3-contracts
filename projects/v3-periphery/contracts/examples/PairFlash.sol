...
import '@donaswap/v3-core/contracts/interfaces/callback/IDonaswapV3FlashCallback.sol';
...
/// @notice An example contract using the Donaswap V3 flash function
contract PairFlash is IDonaswapV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `DonaswapV3FlashCallback`
