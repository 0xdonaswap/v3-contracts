import { abi as IDonaswapV3PoolABI } from '@donaswap/v3-core/artifacts/contracts/interfaces/IDonaswapV3Pool.sol/IDonaswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IDonaswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IDonaswapV3Pool, IDonaswapV3Pool, IDonaswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IDonaswapV3PoolABI, wallet)) as [
      IDonaswapV3Pool,
      IDonaswapV3Pool,
      IDonaswapV3Pool
    ]
  ...
  let pools: [IDonaswapV3Pool, IDonaswapV3Pool, IDonaswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestDonaswapV3Callee')
